...
/*Annotate this activity with android entry point which just allows dagger hilt to inject
* dependencies into this activity or in sub - composables which we need for the view model*/
@AndroidEntryPoint
